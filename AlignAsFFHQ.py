...
'''
Code is modified from https://github.com/happy-jihye/FFHQ-Alignment/blob/master/FFHQ-Alignmnet/ffhq-align.py
'''
...
if __name__ == '__main__':
    import natsort
    path_dir = '/home/undergrad_te/siondijun/originimg/n000624'

    parser = argparse.ArgumentParser(description='A simple script to extract eye and mouth coordinates from a face image.')
    #parser.add_argument('-s', '--src', default='/home/undergrad_te/siondijun/ASFFNet512/TestExamples/ObamaRaw', help='directory of raw images')
    #parser.add_argument('-d', '--dst', default='/home/undergrad_te/siondijun/ASFFNet512/TestExamples/HQReferences/Obama', help='directory of aligned images')
    parser.add_argument('-s', '--src', default=path_dir, help='directory of raw images')
    parser.add_argument('-d', '--dst', default='/home/undergrad_te/siondijun/new624/', help='directory of aligned images')
    ...
    for img_name in os.listdir(args.src):
        ...
        for i, face_landmarks in enumerate(landmarks_detector.get_landmarks(raw_img_path), start=1):
            ...
            aligned_face_path = os.path.join(args.dst, f'{save_name}')
