...
land_dir = '/home/undergrad_te/siondijun/ASFFNetResult_'+'200'+'_Landmarks/'#랜드마크 폴더/
save_path='/home/undergrad_te/siondijun/ASFFNet_facecccv_to_coderesult'
asff_path='/home/undergrad_te/siondijun/ASFFNetResult_'+'200'
low_path='/home/undergrad_te/siondijun/CodeformersResult_200_move'

file_list = os.listdir(land_dir)
file_list=natsort.natsorted(file_list)
os.mkdir(save_path+'200')
for dataforder in file_list:
    os.mkdir(save_path+'200'+'/'+dataforder)#저장경로
    ...
    for imgdata in  file_list2:
        if os.path.isfile(asff_path+"/"+dataforder+"/"+imgdata.strip(".txt")):#자를 이미지 파일경로
            ...
            im2.save(save_path+'200'+'/'+dataforder+"/"+imgdata.strip(".txt"))
