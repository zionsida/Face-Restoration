...
if __name__ == '__main__':
        ...
        for size_text in ["100","200","300","400","500"]:
            landmark_image_path="/home/undergrad_te/siondijun/ASFFNetResult_"+size_text

            parser = argparse.ArgumentParser()
            parser.add_argument('-s', '--ids_path', type=str, default=landmark_image_path, help='file path that contains many identities')
